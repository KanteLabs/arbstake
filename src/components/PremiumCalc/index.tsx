        ...
        <div className={styles.trade_info_section}>
          <div className={styles.trade_info}>
            ...
            <Text color="#83B037" tag="span" title="pnl">
              {numberFormatter.compact(pnl)} eth
            </Text>
          </div>
          <div className={styles.trade_info}>
            <Text tag="span">gas cost: </Text>
            <Text color="#B80012" tag="span" title="gas">
              {numberFormatter.compact(GAS_COST, 3)} eth
            </Text>
          </div>
          <div className={styles.trade_info}>
            <Text tag="span">profit: </Text>
            <Text color="#83B037" tag="span" title="profit">
              {numberFormatter.compact(pnl - GAS_COST, 3)} eth
            </Text>
          </div>
        </div>
      )}
