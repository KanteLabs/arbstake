  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:description" content="Trade crypto like never before. Zeta lets you trade all your favorite assets at lightning speed without compromising security." />
        ...
        <meta property="twitter:description" content="Trade crypto like never before. Zeta lets you trade all your favorite assets at lightning speed without compromising security." />
        <meta property="twitter:image" content="https://dex.zeta.markets/card.jpg" />
      </Head>
      <body>
        <Main />
        <NextScript />
